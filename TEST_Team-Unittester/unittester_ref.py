...
#    """
    ...
    def test_case_get_soms_raw_1(self):
    ...
    def test_case_get_soms_raw_2(self):
    ...
    def test_case_get_soms_raw_3(self):
    ...
    def test_case_get_soms_raw_4(self):
...
#
    """
    - Function filter_outlier test cases
    """

    def test_case_filter_outlier_1(self):
        info = function_info('filter_outlier','test_1')
        df = srf.filter_outlier(df=load_pickle(str(info[0]['df'])))                                        
        assert_option(self,info,df)
        
    def test_case_filter_outlier_2(self):
        info = function_info('filter_outlier','test_2')
        df = srf.filter_outlier(df=load_pickle(str(info[0]['df'])))                                        
        assert_option(self,info,df)

    def test_case_filter_outlier_3(self):
         with self.assertRaises(TypeError) as context:
             srf.filter_outlier()   
                                        
         self.assertTrue('filter_outlier() takes exactly 1 argument (0 given)'
         in context.exception)
...
#       
#       
    def test_case_filter_undervoltage_1(self):
        info = function_info('filter_undervoltage','test_1')
        df = srf.filter_undervoltage(df=load_pickle(str(info[0]['df'])))                                        
        assert_option(self,info,df)
        
        
    def test_case_filter_undervoltage_2(self):
        info = function_info('filter_undervoltage','test_2')
        df = srf.filter_undervoltage(df=load_pickle(str(info[0]['df'])))                                        
        assert_option(self,info,df)
        
        
    def test_case_filter_undervoltage_3(self):
        with self.assertRaises(TypeError) as context:
             srf.filter_undervoltage() 
                                        
        self.assertTrue('filter_undervoltage() takes exactly 1 argument (0 given)'
         in context.exception)

#    """
#    - Function voltage_compute test cases
#    """
#       
#       
    def test_case_voltage_compute_1(self):
    ...
    def test_case_voltage_compute_2(self):
        info = function_info('voltage_compute','test_2')
        with self.assertRaises(ValueError) as context:
    ...
    def test_case_voltage_compute_3(self):
        info = function_info('voltage_compute','test_3')
        with self.assertRaises(ValueError) as context:
             srf.voltage_compute(column=str(info[0]['column']),
                                 node=int(info[0]['node']),
                                 a_num=int(info[0]['a_num']))   
...
#    
    def test_case_apply_filters_1(self):
         ...
         df = flt.apply_filters2(df=load_pickle(str(info[0]['dfl'])))
         assert_option(self,info,df)    
...
#    
    def test_case_orthogonal_filter_1(self):
         ...
         df = flt.orthogonal_filter2(df=load_pickle(str(info[0]['df'])))
         assert_option(self,info,df)      
...
##    
    def test_case_outlier_filter_1(self):
         ...
         df = flt.outlier_filter(df=load_pickle(str(info[0]['dff'])))
         assert_option(self,info,df)      
