...
def function_info(function_name,test_id):
    test_case_info = set_cnf(file='unittester_config.cnf')
...
class TestModule(unittest.TestCase):
    ...
    def test_case_get_raw_accel_data_1(self):
         info = function_info('get_raw_accel_data','test_1')
    ...
    def test_case_get_raw_accel_data_4(self):
         info = function_info('get_raw_accel_data','test_4')
         df = querydb.get_raw_accel_data(tsm_id= int(info[0]['tsm_id']), 
                                         analysis= str(info[0]['analysis']), 
                                         from_time= str(info[0]['from_time']))
         assert_option(self,info,df)
             
                   
    def test_case_get_raw_accel_data_5(self):
         info = function_info('get_raw_accel_data','test_5')
         df = querydb.get_raw_accel_data(tsm_id= int(info[0]['tsm_id']),
                                         to_time= str(info[0]['to_time']),
                                         from_time= str(info[0]['from_time']), 
                                         return_db= ast.literal_eval(str(
                                         info[0]['return_db'])))
         assert_option(self,info,df)
    ...
    def test_case_get_raw_accel_data_6(self):
         info = function_info('get_raw_accel_data','test_6')

         with self.assertRaises(IndexError) as context:
            querydb.get_raw_accel_data(tsm_id= int(info[0]['tsm_id']))
        
         self.assertTrue('single positional indexer is out-of-bounds' in context.exception)
         
    def test_case_get_raw_accel_data_7(self):
         info = function_info('get_raw_accel_data','test_7')

         with self.assertRaises(KeyError) as context:
            querydb.get_raw_accel_data(tsm_id= int(info[0]['tsm_id']))
            
         self.assertTrue('tsm_id' in context.exception)
         
    def test_case_get_raw_accel_data_8(self):
         info = function_info('get_raw_accel_data','test_8')
         df = querydb.get_raw_accel_data(tsm_id= int(info[0]['tsm_id']),
                                       from_time = str(info[0]['from_time']),
                                       to_time= str(info[0]['to_time']))
    ...
    def test_case_get_raw_accel_data_9(self):
         info = function_info('get_raw_accel_data','test_9')
    ...
    def test_case_get_raw_accel_data_10(self):
         info = function_info('get_raw_accel_data','test_10')
