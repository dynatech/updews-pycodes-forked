...
class config:
	def __init__(self):
		...
		serverdir = cfg.get("FileIO","serverdir")
		logsdir = cfg.get("FileIO","logsdir")
		self.fileio.allalertsfile = serverdir + cfg.get("FileIO","allalertsfile")
		self.fileio.eqprocfile = serverdir + cfg.get("FileIO","eqprocfile")
		self.fileio.queryoutput = serverdir + cfg.get("FileIO","querylatestreportoutput")
		self.fileio.alertgenscript = serverdir + cfg.get("FileIO","alertgenscript")
		self.fileio.alertanalysisscript = serverdir + cfg.get("FileIO","alertanalysisscript")
		self.fileio.masyncscript = serverdir + cfg.get("FileIO","masyncscript")
		self.fileio.masynclogs = logsdir+ cfg.get("FileIO","masynclogs")
		self.fileio.websocketdir = serverdir + cfg.get("FileIO","websocketdir")
		self.fileio.gndalert1 = serverdir + cfg.get("FileIO","gndalert1")
		self.fileio.gndalert2 = serverdir + cfg.get("FileIO","gndalert2")
		self.fileio.gndalert3 = serverdir + cfg.get("FileIO","gndalert3")
