...
query = "SELECT id,timestamp, UPPER(crack_id) AS crack_id,meas FROM senslopedb.gndmeas where timestamp between '%s' and '%s 23:59:59' and site_id ='%s' and meas <= '500' order by site_id asc"%(fdate,tdate,gsite) 
